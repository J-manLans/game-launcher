...
public class Manager extends JFrame {
    ...
    void setupAndStartGUI() {
        ...
        this.setAndCenterLabel(this.centerPanel, this.resourceLabel, Integer.toString(this.startingPoolSize), centerPanelFontSize, Color.ORANGE);
    ...
    private class CirclePanel extends JPanel {
         ...
         *
         * @param currentPoolSize the current size of the resource pool to be represented
         */
         ...
         *
         * @param currentPoolSize the current size of the resource pool
     ...
     * @param typeToAdd the type of client to add ("Producer" or "Consumer")
     */
    private void modifyClientLists(Runnable client, String typeToAdd) {
        ...
        if (clients.size() < 11) {
            ...
            // Adds new client thread and starts it up if no clients have been switched from the waiting list to the client list
            if (!switchedClient) {
